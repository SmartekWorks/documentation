...
1. SWATHubロボットを**スタンドアロンモード**で実行する場合の**サブスクリプション**手順は以下のとおりです。<sup>5</sup>：

![図7 ロボットスタンドアロンモード1](../assets/img/manual-robot_alone-03.png)

![図9 ロボットスタンドアロンモード3](../assets/img/manual-robot_alone-02.png)
...
?> 5. SWATHubロボットが**グリッドモード**または**開発モード**で実行されている場合、サブスクリプションをアクティブにする必要はありません。
...
* **ロボットモード**: 現在の実行要件に基づいて、SWATHubロボットを[開発モード](robot_execution.md)、[スタンドアロンモード](robot_execution.md)、または[グリッドモード](robot_execution.md)で実行します。
