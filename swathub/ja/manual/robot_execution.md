...
SWATHubロボットが**SWATHubデザインプラットフォーム**または**SWATHub管理プラットフォーム**に接続されている場合、**設定**画面から**ノードモード**を選択して実行できます。この場合、SWATHubロボットは**デザインプラットフォーム**または**管理プラットフォーム**の制御ロボットサブスクリプションを占有し、追加のロボットサブスクリプションは必要ありません。
### デザインプラットフォームに接続する
